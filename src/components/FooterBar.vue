<template>
    <footer class="flex flex-col bg-purple-950 text-white px-32">
        <div class="w-full flex items-center justify-between py-16">
        ...
        <div class="w-full flex items-center justify-between py-12">
            <span class="text-xl font-semibold">Pliušinukai</span>
            <span class="text-sm text-purple-10">© 2023 Pliušinukai. Visos teisės saugomos.</span>
        </div>
    </footer>
</template>
