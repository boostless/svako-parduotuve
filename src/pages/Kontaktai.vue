...
<template>
    <div class="w-full min-h-screen px-8 sm:px-16 md:px-32 pb-24 bg-purple-50">
        ...
        <main class="w-full flex items-center justify-center">
            <form class="w-full flex flex-col md:w-4/5 lg:w-2/5 h-fit space-y-8" name="contact" method="POST" data-netlify="true" data-netlify-honeypot="bot-field">
                <div class="w-full flex flex-col sm:flex-row justify-between space-y-8 sm:space-y-0 sm:space-x-8">
                    <div class="grid space-y-2 w-full">
                        ...
                        <input required="true" class="border rounded-lg px-4 py-3 outline-none shadow" id="name" type="name" placeholder="Vardenis"/>
                    </div>
                    <div class="grid space-y-2  w-full">
                        <label class="font-medium text-sm" for="surname">Pavardė <span class="text-red-500">*</span></label>
                        <input required="true" class="border rounded-lg px-4 py-3 outline-none shadow" id="surname" type="surname" placeholder="Pavardenis"/>
                    </div>
                </div>
                <div class="w-full space-y-2">
                    ...
                    <div class="bg-white px-4 py-3 border rounded-lg flex items-center space-x-2 shadow">
                        ...
                        <input required="true" type="email" class=" text-black outline-none" placeholder="El. paštas" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" title="vardenis@pastas.lt"/>
                    </div>
                </div>
                <div class="w-full grid space-y-2">
                    <label class="font-medium text-sm" for="phone">Telefono numeris</label>
                    <input class="border rounded-lg px-4 py-3 outline-none shadow" id="phone" type="phone" pattern="+370+{8}" placeholder="+370 616 50600"/>
                </div>
                <div class="w-full grid space-y-2">
                    <label class="font-medium text-sm" for="message">Žinutė <span class="text-red-500">*</span></label>
                    <textarea required="true" class="border p-3 rounded-lg resize-none h-32" placeholder="Įrašykite žinutę..."></textarea>
                </div>
